...
/// Panics: If file is not found or failed to read file.
pub fn conf_lines_from_path(path: impl ToString) -> Vec<String> {
...
mod tests {
    ...
    #[test]
    fn test_read_lines() {
        let lines = conf_lines_from_path("./test_data/file_read_test.conf");
